                                ...
                                <div class="container-fluid">
                                    <form method="POST" action="{{ route('workers.update', $worker->id) }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                            <input id="name" type="text" class="form-control" @error('location') is-invalid @enderror" name="name" value="{{ $worker->name }}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                              <input id="phonenumber" type="tel" pattern="[0-9]{4}-[0-9]{6}" class="form-control @error('phonenumber') is-invalid @enderror" name="phonenumber" value="{{ $worker->phonenumber }}" required>
