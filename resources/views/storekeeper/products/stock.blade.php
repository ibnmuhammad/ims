...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Register New Product Stock</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <section class="content">
                                <div class="container-fluid">
                                    <form method="POST" action="{{ route('product.storeStock', $product->id) }}">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            <label for="stock" class="col-md-4 col-form-label text-md-right">{{ __('New Product Stocks') }}</label>
