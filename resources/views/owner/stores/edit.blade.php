...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Store Details</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                                ...
                                <div class="container-fluid">
                                    <form method="POST" action="{{ route('stores.update', $store->id) }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="name" type="text" class="form-control" @error('location') is-invalid @enderror" name="name" value="{{ $store->name }}" required>
                                        ...
                                        <div class="form-group row">
                                            <label for="location" class="col-md-4 col-form-label text-md-right">{{ __('Store Location') }}</label>
                
                                            <div class="col-md-6">
                                                <input id="lcoation" type="text" class="form-control @error('location') is-invalid @enderror" name="location" value="{{ $store->location }}" required>
